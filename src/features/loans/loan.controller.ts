...
export class LoanController {
  static readonly get = async (req: Request, res: Response, next: NextFunction) => {
  ...
  static readonly getById = async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
  ...
  static readonly update = async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
  ...
  static readonly delete = async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
